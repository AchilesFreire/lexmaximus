object FrmConfiguracoes: TFrmConfiguracoes
  ...
  object Panel1: TPanel
    ...
    object GroupBox3: TGroupBox
      ...
      object Chk_ExibirDicaBotoes: TCheckBox
        Left = 11
        Top = 51
        Width = 342
        Height = 17
        Caption = 'Exibir dica de bot'#245'es de navega'#231#227'o na pesquisa'
        TabOrder = 1
      end
      object Chk_UsarApenasUmClique: TCheckBox
        Left = 11
        Top = 72
        Width = 342
        Height = 17
        Caption = 'Usar apenas um clique para exibir resultados da pesquisa'
        TabOrder = 2
      end
    end
  end
