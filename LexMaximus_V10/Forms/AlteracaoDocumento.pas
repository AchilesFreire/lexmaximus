...
begin
  ...
  L := TRul_Lei.Create(VarConexao.Conexao, varLei);

  ArquivoDescomprimido := GetCurrentDir + '\HTML\' +  L.Link;
  ArquivoComprimido := Copy( ArquivoDescomprimido , 1, Length(ArquivoDescomprimido)-4);
